...
<<<<<<< HEAD
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-50 rounded-full bg-white/90 hover:bg-white shadow-lg p-2 transition-all duration-200 hover:scale-110"
          aria-label="Close"
        >
...
<<<<<<< HEAD
            ...
            <Button 
              variant="outline" 
              className="w-full text-base py-3 border-gray-300 hover:bg-gray-50" 
              onClick={onClose}
            >
              CANCEL
            </Button>
